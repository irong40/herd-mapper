...
export default function StatusBar() {
  return (
    <div className="h-12 bg-slate-900 border-b border-slate-700 flex items-center px-4 gap-6 shrink-0">
      ...
      <Stat label="Clusters" value={clusters.length} color="text-green-400" />
      <Stat label="Animals" value={totalDeer} color="text-green-300" />
      <Stat label="Pass 2 WPs" value={pass2Waypoints.length} color="text-indigo-400" />
